...
const ALL_PLANS = [
  {
    name: "Başlangıç", slug: "baslangic", priceCents: 49900, currency: "TRY", interval: "month" as const, trialDays: 0,
  ...
  {
    name: "Profesyonel", slug: "profesyonel", priceCents: 99900, currency: "TRY", interval: "month" as const, trialDays: 0,
  ...
  {
    name: "İşletme", slug: "isletme", priceCents: 189900, currency: "TRY", interval: "month" as const, trialDays: 0,
  ...
  {
    name: "Ajans", slug: "ajans", priceCents: 349900, currency: "TRY", interval: "month" as const, trialDays: 0,
